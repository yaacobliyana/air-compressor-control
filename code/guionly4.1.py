...
#Adding background to page
bg2 = Image.open('images/bgrnd.png')
...
#Inserting Tank Image
gt1 = Image.open('images/tank.png')
res_gt1 = gt1.resize((54, 220), Image.ANTIALIAS)
newgt1 = ImageTk.PhotoImage(res_gt1)
tank1 = Label(tab3, image=newgt1, bg='black')

#Inserting Tank 2 Image
gt3 = Image.open('images/tank2.png')
res_gt3 = gt3.resize((54, 220), Image.ANTIALIAS)
newgt3 = ImageTk.PhotoImage(res_gt3)
...
def placeTurbine2():
    global turbine
    turbine = Label(tab3, image=newtt2, bg='black')
    turbine.place(x=350,y=137)
...
#Inserting Start Button Image
sb1 = Image.open('images/start2.png')
res_sb1 = sb1.resize((150, 51), Image.ANTIALIAS)
newsb1 = ImageTk.PhotoImage(res_sb1)
...
#Inserting gauge widget
p1 = gaugelib.DrawGauge2(tab3, max_value=300.0, min_value=0.0,
                        size=130, bg_col='black',
                        unit="psi", bg_sel=2)
#Inserting gauge widget
p2 = gaugelib.DrawGauge2(tab3, max_value=300.0, min_value=0.0,
                        size=130, bg_col='black',
                        unit="psi", bg_sel=2)

#START Button
start_btn1 = Button(tab3, image=newsb1, command=start, 
                    borderwidth=0, bg='black',activebackground='black')

stop_btn1 = Button(tab3, image=newstb, command=stop, 
                    borderwidth=0, bg='black',activebackground='black')
...
date3.place(x=260,y=60)
clock3.place(x=425,y=60)
btab3.place(x=635,y=70)
p1.place(x=25,y=140)
p2.place(x=650,y=140)
start_btn1.place(x=250, y=320)
stop_btn1.place(x=410,y=320)

tank1.place(x=575,y=137)
tank3.place(x=175,y=137)
