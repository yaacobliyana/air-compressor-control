...
#Adding background to page
bg2 = Image.open('images/latestbgrnd2.png')
...
#Inserting frame for animation
paper = Canvas(tab3, bg='black', width=600, height=265)
...
#Inserting Tank Image
gt4 = Image.open('images/tank.png')
res_gt4= gt4.resize((54, 220), Image.ANTIALIAS)
newgt4 = ImageTk.PhotoImage(res_gt4)
...
##....DISPLAYING VARIABLE ON SCREEN.....##
#
paper.place(x=170,y=110)
btab3.place(x=635,y=70)
date3.place(x=260,y=70)
clock3.place(x=425,y=70)
tank3.place(x=200,y=137)
tank4.place(x=690,y=137)
